...
def main():
    ...
    available_features = [
        ...
        "Low",
        "Close",
        "Volume",  # Preços e volume básicos
        "RSI",
        "Stoch_K",
        "Stoch_D",
        "Awesome_Oscillator",  # Indicadores de momentum
        "MACD",
        "MACD_signal",
        "MACD_diff",  # MACD
        "CCI",
        "ADX",
        "ADX_pos",
        "ADX_neg",  # Indicadores de tendência
        "BB_upper",
        "BB_middle",
        "BB_lower",  # Bandas de Bollinger
        "EMA_20",  # Média móvel exponencial
        "ATR",  # Volatilidade
        "VWAP",
        "OBV",
        "AccDistIndex",  # Indicadores de volume
        "Candle_Body",
        "Candle_Range",
        "Upper_Shadow",
        "Lower_Shadow",  # Candlestick features
    ]
    ...
    for trial in range(n_trials):
        ...
        try:
            ...
            results.append({"trial": trial + 1, "error": str(e), **params})
